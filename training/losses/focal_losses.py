"""Original implementation: https://github.com/kornia/kornia/blob/e3054501e9bc70269adef53e9c3f98c3c1480f26/kornia/losses/focal.py
"""
...
def focal_loss(
    ...
    target_one_hot: torch.Tensor = F.one_hot(
        target, num_classes=input.shape[1]).to(input.dtype).to(input.device)
